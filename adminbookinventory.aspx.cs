...
namespace ElibraryManagement
{
    ...
    //                SqlCommand cmd = new SqlCommand("SELECT * from book_master_tb1 where bok_id='" + TextBox1.Text.Trim() + "' OR book_name='" + TextBox2.Text.Trim() + "';", con);
    //                SqlDataAdapter da = new SqlDataAdapter(cmd);
    //                DataTable dt = new DataTable();
    //                da.Fill(dt);
    ...
    //                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(bok_id,book_name,genre,author_name,publisher_name,publish_date,language,edition,book_cost,no_of_pages,book_description,actual_stock,current_stock,book_img_link) values(@bok_id,@book_name,@genre,@author_name,@publisher_name,@publish_date,@language,@edition,@book_cost,@no_of_pages,@book_description,@actual_stock,@current_stock,@book_img_link)", con);

    //                cmd.Parameters.AddWithValue("@bok_id", TextBox1.Text.Trim());
    ...
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        void deleteBookByID()
        {
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE from book_master_tb1 WHERE bok_id='" + TextBox1.Text.Trim() + "'", con);
        ...
        void getBookByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_master_tb1 WHERE bok_id='" + TextBox1.Text.Trim() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tb1(bok_id,book_name,genre,author_name,publisher_name,publish_date,language,edition,book_cost,no_of_pages,book_description,actual_stock,current_stock,book_img_link) values(@bok_id,@book_name,@genre,@author_name,@publisher_name,@publish_date,@language,@edition,@book_cost,@no_of_pages,@book_description,@actual_stock,@current_stock,@book_img_link)", con);
